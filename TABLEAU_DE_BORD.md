...
- Visualisation des galeries publiques et privées hors-ligne (via Isar)
- Saisie de code pour accéder à des galeries privées
- Visualisation des photos avec gestion du chargement
- Ajout de commentaires sur les photos des galeries privées
- Communication avec le backend via Dio (qui sert à faire des requêtes HTTP)
